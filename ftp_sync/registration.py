...
CLI: dict[str, Any] = {   'shared_parameters': [   {   'name': 'config-path',
                             ...
                             {   'name': 'ctx-file',
                                 ...
                                 'description': 'Pipeline step ctx '
                                                ...
                                                'exclusive with '
                                                'config-path.'}],
    'parameters': [   {   'name': 'resync',
                          'required': False,
                          'value_type': 'flag',
                          'possible_values': ['present'],
                          'default': True,
                          'description': 'Check every remote file against '
                                         'state.'},
                      {   'name': 'no-resync',
                          'required': False,
                          'value_type': 'flag',
                          'possible_values': ['present'],
                          'description': 'Use high-water mark stamps to '
                                         'skip older remote files.'}]}
